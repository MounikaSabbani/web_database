...
<html lang="en" >
  ...
  <head>
    ...
    <script src="../js/home_page_validation.js"></script> 
  ...
  <button onclick="window.location.href = '../html/subscription.html'" class="button subscribe" style="position: absolute; right:10px; bottom:-250px;">
