  ...
  <div class="topnav">
	  ...
	  <span class = "status hidden"></span>
       ...
       $sql2 = "SELECT  S.Story_id,S.Story_name,S.Story_image 
		...
		$html = "<html><h1>".$result_story['Story_name']."</h1><img src = data:image/jpeg;base64,".base64_encode($result_story['Story_image'])." class=\"center\"> <p><a href=\"approved_books.php\">GO BACK to Previous Page view</a></p>";
